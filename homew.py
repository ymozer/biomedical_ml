...
for i in range(9):
    for j in range(2):
        ...
        if j ==0:
            ...
            lr='R'
img_bgr = cv2.imread('Dataset/CHASEDB1/Image_01L.jpg')
plot(img_bgr,"bgr")
...
labeled_img = cv2.imread(f'Dataset/CHASEDB1/Image_01L_1stHO.png')
labeled_img = cv2.cvtColor(labeled_img, cv2.COLOR_BGR2GRAY)
labeled_img1 = labeled_img.reshape(-1)
plot(labeled_img,'labeled')
...
for i in range(9):
    for j in range(2):
        ...
        plt.imsave(f'segmented_eye_estimated{i}.jpg', segmented, cmap ='jet')
        plt.imsave(f'segmented_selected_perm{i}.jpg', segmented_selected_perm, cmap='jet')
        plt.imsave(f'segmented_selected_sfm{i}.jpg', segmented_selected_sfm, cmap='jet')
        plt.imsave(f'segmented_selected_mdi{i}.jpg', segmented_selected_mdi, cmap='jet')
